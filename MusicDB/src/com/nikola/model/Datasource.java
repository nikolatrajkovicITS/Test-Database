...
public class Datasource {
    ...
    // Modify this method with constants
    ...
    public List<String> queryAlbumsForArtist(String artistName, int sortOrder) {
        ...
        sb.append("\"");      // to close of the query for artist
    ...
    public List<SongArtist> queryArtistsForSong(String songName, int sortOrder) {
        ...
        System.out.println("SQL Statement: " + sb.toString());        // Printout the SQL statement
    ...
    public void querySongsMetadata() {
        ...
        try (Statement statement = conn.createStatement();
            ...
            for(int i = 1; i <= numColumns; i++) {
                System.out.format("Coulmun %d in the songs table is names %s\n",
    ...
    public int getCount(String table) {
        String sql = "SELECT COUNT(*) AS count FROM " + table;     // we're getting the min result now
        try(Statement statement = conn.createStatement();
            ResultSet results = statement.executeQuery(sql)) {

            int count = results.getInt("count");  // To get results, we treat function result as a column
